  ...
  const allowedGroups = [
    'Paci testing',
    'Waassta Invoices',
    'Paci <> Etiquette4everyone',
    'Paci <> KW Fitness',
    'Paci <> Sassi DxB',
    'Paci <> FeedKiani',
    'Paci <> The People Agency',
    'Paci <> Flo Akinbiyi',
    'Paci <> Paive',
    'AR Accounts - Paci',
    'Paci <> Chloe Mac Consultancy',
    'Paci <> Square2mm',
    'Paci <> Peek a boo',
    'Paci <> Sofia Sands',
    'Paci <> LingLux',
    'Paci <> Sumac',
    'Paci <> Dubayt Holiday Homes',
    'Paci <> Tangerine',
    'Paci <> Ethnic Collections',
    'Paci <> Ascent Technologies',
    'Paci <> Voltage performance',
    'Paci <> Linda Moore Foodstuff',
    'Paci <> Nabu',
    '1. Paci <> CHAT GROUP Number One Yacht',
    'Paci <> GingerCat',
    'Paci <> The Craft Safari',
    'Paci <> Zeus Accomodations',
    'Paci <> Sims Blossoms',
    'Paci <> Lammah Space',
    'Paci <> Coco & Shy',
    'Paci <> Double Woof',
    ...
    'Paci <> Prime Vision',
    'Paci <> Mega Realty',
    'Paci <> Magro International',
    'Paci <> Lovelash',
    'Paci <> Yes Marhaba',
    'Paci <> Bailey & Jools',
    'Paci <> Wishing Well DXB',
    'Check with Ram',
    'Paci <> Another',
    'Paci <> Teatopia Bliss',
    'Paci <> Kwelio',
    'Paci <> Sooqna',
    'Paci X Social',
    'Paci <> Global Consulting LLC',
    'Check with Ram',
    'Paci <> Mozaic People',
    'Paci <> Next Book',
    'Paci <> Kwelio',
    'Paci <> Pam’s Creations',
    'Paci <> Mini Master',
    'Accounts Paci <> Enaya Education',
    'Paci <> Anantara',
    'Paci <> Globalex',
    'Paci <> Zalam Zimbo',
    'Paci <> Vibe tribe',
    ...
    'Paci <> Esti Athens',
    'Paci <> Carousel Moms',
    'Paci <> Heart2Heart Weddings',
    'Paci <> XrateCapital',
    'Paci <> eBoutik',
    'Paci <> Mindful Solutions',
    'Paci <> Suenos fragrances',
    'Paci <> Waffle communications',
    'Paci <> Luxlife Clinic',
    'Paci <> Sitesee Tech',
    'Paci <> Bitmern',
    'Paci <> Fameyss Hospitality',
    'Paci <> SMA accounts',
    'Paci <> Global ME recruitment',
    'Paci <> Organic Living',
    'Paci <> Tactical'
  ];
